...
/*
 * $Id: animation.h 6812 2006-06-11 04:20:45Z weiym $
 *
 ...
 * \sa DestroyAnimation, ANIMATION
 */
MGEXT_EXPORT ANIMATION* CreateAnimationFromGIF89aFile (HDC hdc, const char* file);
 ...
 * \sa DestroyAnimation, ANIMATION
 */
MGEXT_EXPORT ANIMATION* CreateAnimationFromGIF89aMem (HDC hdc, const void* mem, int size);
 ...
 */
MGEXT_EXPORT void DestroyAnimation (ANIMATION* anim, BOOL free_it);
