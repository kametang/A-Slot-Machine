...
/*
 * $Id: common.h 6915 2006-06-26 06:31:07Z xwyan $
 *
...
#if defined (__UCOSII__) || defined (__VXWORKS__) || defined(WIN32) || defined (__NUCLEUS__) || defined (__PSOS__)
...
#if defined(_USE_OWN_PTHREAD) && defined(__VXWORKS__)
