...
/*
 * $Id: mywindows.h 6812 2006-06-11 04:20:45Z weiym $
 *
...
/**
 * \fn int myMessageBox (HWND hwnd, DWORD dwStyle, char* title,\
                char* text, ...)
 ...
 */
MGEXT_EXPORT int myMessageBox (HWND hwnd, DWORD dwStyle, char* title,
                char* text, ...);

/**
 * \fn int myWinMessage (HWND hwnd, char* title, char* button1,\
                char* text, ...)
 ...
 */
MGEXT_EXPORT int myWinMessage (HWND hwnd, char* title, char* button1,
                char* text, ...);

/**
 * \fn int myWinChoice (HWND hwnd, char* title,\
 ...
 */
MGEXT_EXPORT int myWinChoice (HWND hwnd, char* title, 
                char* button1, char* button2, char* text, ...);

/**
 * \fn int myWinTernary (HWND hwnd, char* title,\
 ...
 * \sa myWinChoice, printf(3)
 */
MGEXT_EXPORT int myWinTernary (HWND hwnd, char* title, 
                char* button1, char* button2, char* button3, char* text, ...);
 ...
 */
MGEXT_EXPORT void errorWindow (HWND hwnd, char * str, char* title);
...
/**
 * \fn HWND createProgressWin (HWND hParentWnd, char *title,\
 ...
 */
MGEXT_EXPORT HWND createProgressWin (HWND hParentWnd, char * title, 
                char * label, int id, int range);
