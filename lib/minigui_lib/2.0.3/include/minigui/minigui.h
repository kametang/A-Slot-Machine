...
/*
 * $Id: minigui.h 6812 2006-06-11 04:20:45Z weiym $
 * 
...
/**
* \def LCO_NEW_CLIENT
* \brief Connecting a new client to the server.
* \sa OnNewDelClient
**/
#define LCO_NEW_CLIENT      1
/**
* \def LCO_DEL_CLIENT
* \brief Disconnecting a new client from the server.
* \sa OnNewDelClient
**/
...
/**
* \def LCO_NEW_LAYER
* \brief Creating a new layer.
* \sa OnChangeLayer
**/
#define LCO_NEW_LAYER       1
/**
* \def LCO_DEL_LAYER
* \brief Deleting a new layer.
* \sa OnChangeLayer
**/
#define LCO_DEL_LAYER       2
/**
* \def LCO_JOIN_CLIENT
* \brief Joining a client to the layer.
* \sa OnChangeLayer
**/
#define LCO_JOIN_CLIENT     3
/**
* \def LCO_REMOVE_CLIENT
* \brief Removing a client from the layer.
* \sa OnChangeLayer
**/
#define LCO_REMOVE_CLIENT   4
/**
* \def LCO_TOPMOST_CHANGED
* \brief The topmost layer has changed, the layer will be the topmost one.
* \sa OnChangeLayer
**/
#define LCO_TOPMOST_CHANGED 5
/**
* \def LCO_ACTIVE_CHANGED
* \brief The active client has changed, the client will be the active one.
* \sa OnChangeLayer
**/
...
/** 
 * \fn ClientRequest (PREQUEST request, void* result, int len_rslt)
...
/** 
 * \fn ServerSendReply (int clifd, const void* reply, int len)
 ...
 *       _MISC_ABOUTDLG defined. For MiniGUI-Threads, you should 
 ...
 */
MG_EXPORT const char* GetSysText (const char* text);
...
/**
 * \fn int substrlen (const char* text, int len, char delimiter,\
                int* nr_delim)
 ...
 * \sa strstr(3)
 */
MG_EXPORT int substrlen (const char* text, int len, char delimiter,
                int* nr_delim);
