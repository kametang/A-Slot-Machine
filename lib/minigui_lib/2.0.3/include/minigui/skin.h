...
/*
 * $Id: skin.h 6812 2006-06-11 04:20:45Z weiym $
 *
 ...
 *               int x, int y, int w, int h, DWORD dwExStyle, BOOL modal)
...
MGEXT_EXPORT HWND create_skin_main_window_ex (skin_head_t* skin, HWND hosting, 
                int x, int y, int w, int h, DWORD dwExStyle, BOOL modal);
/**
 * \def create_skin_main_window(skin, hosting, x, y, w, h, modal)
 * \sa create_skin_main_window_ex (skin, hosting, x, y, w, h, 0, modal)
 */
#define create_skin_main_window(skin, hosting, x, y, w, h, modal) \
