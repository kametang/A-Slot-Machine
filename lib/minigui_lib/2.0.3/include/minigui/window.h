...
/* 
 * $Id: window.h 6898 2006-06-24 04:09:22Z xwyan $
 *
 ...
 */               
MG_EXPORT BOOL GUIAPI PeekMessage (PMSG pMsg, HWND hWnd,
                int iMsgFilterMin, int iMsgFilterMax, UINT uRemoveMsg);
 ...
 * \param speed The timeout value of the timer. By default, the timeout value 
 *        is in unit of 10 ms.
 * \return TRUE on success, FALSE on error.
 * 
 ...
 *       \a speed represents the timeout value of the timer, in the unit of 
 *       10ms, else is the frequency. If \a speed represents the frequency 
 *       of the timer, when it is equal to 10, the timer will expire after 
 *       every second.
 *
 ...
 * \param dwStyle The style of the message box, can be one or'ed value of 
